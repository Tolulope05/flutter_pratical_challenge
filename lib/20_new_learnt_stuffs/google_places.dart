...
Future<Map<String, dynamic>> getUsersCountry(String latitude,
...
Future<Map<String, dynamic>> placeDetails(String placeId,
      String sessionToken) async {
    Uri requestUrl =
    Uri.parse("${googlePlaceDetailsBaseUrl}?place_id=$placeId"
        "&key=$googleMapsApiKey&sessiontoken=$sessionToken");
...
Map<String, dynamic> location = placeDetails["result"]["geometry"]["location"];
